...
// ==============================================================================
// Eggstra - Executive Dashboard Metric Cards (Philippine Peso ₱ & Dual Theme)
// ==============================================================================
        ...
        <div className="glass-panel glass-panel-hover rounded-2xl p-4 sm:p-5 relative overflow-hidden">
          <div className="flex items-start justify-between">
            <div>
              ...
              <h3 className="text-2xl sm:text-3xl font-extrabold text-slate-900 dark:text-slate-100 font-mono mt-1.5">
          ...
          <div className="mt-3 flex items-center justify-between text-xs text-slate-500 dark:text-slate-400 pt-2 border-t border-slate-200 dark:border-slate-800">
            <span className="truncate max-w-[150px]">{selectedFlockName}</span>
            <span className="font-semibold text-emerald-600 dark:text-emerald-400">100% Tracked</span>
          </div>
        </div>
        ...
        <div className="glass-panel glass-panel-hover rounded-2xl p-4 sm:p-5 relative overflow-hidden">
          <div className="flex items-start justify-between">
            <div>
              ...
              <h3 className="text-2xl sm:text-3xl font-extrabold text-amber-600 dark:text-amber-300 font-mono mt-1.5">
        ...
        <div className="glass-panel glass-panel-hover rounded-2xl p-4 sm:p-5 relative overflow-hidden">
          <div className="flex items-start justify-between">
            <div>
              ...
              <h3
                className={`text-2xl sm:text-3xl font-extrabold font-mono mt-1.5 ${
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div className="glass-panel rounded-2xl p-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs text-slate-500 dark:text-slate-400">Today&apos;s Net Margin (PHP)</p>
          ...
          <div className="text-right text-xs">
            <p className="text-emerald-600 dark:text-emerald-400 font-mono font-medium">+{formatPHP(metrics.todayRevenue, 0)}</p>
            <p className="text-slate-400 font-mono">-{formatPHP(metrics.todayExpense, 0)}</p>
          </div>
        </div>
        ...
        <div className="glass-panel rounded-2xl p-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs text-slate-500 dark:text-slate-400">30-Day Net Margin (PHP)</p>
              <p className="text-lg font-bold text-teal-700 dark:text-teal-300 font-mono">
                {formatPHP(metrics.monthlyNetProfit)}
              </p>
            </div>
          </div>
          <div className="text-right text-xs">
            <p className="text-emerald-600 dark:text-emerald-400 font-mono font-medium">+{formatPHP(metrics.monthlyRevenue, 0)}</p>
            <p className="text-slate-400 font-mono">-{formatPHP(metrics.monthlyExpense, 0)}</p>
          </div>
        </div>
        ...
        <div className="glass-panel rounded-2xl p-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs text-slate-500 dark:text-slate-400">Feed Conversion (FCR)</p>
              <p className="text-lg font-bold text-amber-700 dark:text-amber-300 font-mono">
                {metrics.feedConversionRatio} <span className="text-xs text-slate-400 font-normal">kg/doz</span>
              </p>
            </div>
          </div>
          <div className="text-right text-xs">
            <span className="px-2 py-0.5 rounded-full bg-emerald-500/10 text-emerald-700 dark:text-emerald-400 border border-emerald-500/20 font-semibold">
              Standard
            </span>
          </div>
        </div>
